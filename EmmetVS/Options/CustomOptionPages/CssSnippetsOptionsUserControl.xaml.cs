...
/// <summary>
/// Interaction logic for CssSnippetsOptionsUserControl.xaml
/// </summary>
public partial class CssSnippetsOptionsUserControl : UserControl
{
    public ObservableCollection<KeyValuePair<string, string>> SettingsDict { get; set; }

    public CssSnippetsOptionsUserControl()
    {
        InitializeComponent();

        SettingsDict = new ObservableCollection<KeyValuePair<string, string>>(CssOptions.Instance.Snippets);
    ...
    private async void AddEventHandler(object sender, bool isCancelled)
    {
        try
        {
            ...
            if (!isCancelled)
            {
                ...
                {
                    var currentSnippets = CssOptions.Instance.Snippets;
                    currentSnippets.Add(dialogControl.Key, dialogControl.Value);
                    CssOptions.Instance.Snippets = currentSnippets;
