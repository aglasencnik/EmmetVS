...
/// <summary>
/// Interaction logic for HtmlSupportedFileTypesOptionsUserControl.xaml
/// </summary>
public partial class HtmlSupportedFileTypesOptionsUserControl : UserControl
{
    public ObservableCollection<string> SettingsCollection { get; set; }

    public HtmlSupportedFileTypesOptionsUserControl()
    {
        InitializeComponent();

        SettingsCollection = new ObservableCollection<string>(HtmlOptions.Instance.SupportedFileTypes);
    ...
    private void OnAdd(object sender, RoutedEventArgs e)
    {
        ...
        {
            Title = "Add new HTML supported file type",
    ...
    private async void AddEventHandler(object sender, bool isCancelled)
    {
        try
        {
            ...
            if (!isCancelled)
            {
                ...
                {
                    var currentFileTypes = HtmlOptions.Instance.SupportedFileTypes;
                    currentFileTypes.Add(dialogControl.Value);
                    HtmlOptions.Instance.SupportedFileTypes = currentFileTypes;
    ...
    private void OnEdit(object sender, RoutedEventArgs e)
    {
        ...
        var dialogWindow = new Window()
        {
            Title = "Edit HTML supported file type",
            Content = dialogControl,
            SizeToContent = SizeToContent.WidthAndHeight,
            ResizeMode = ResizeMode.CanResizeWithGrip,
            WindowStartupLocation = WindowStartupLocation.CenterScreen
    ...
    private void OnDelete(object sender, RoutedEventArgs e)
    {
        ...
        var dialogWindow = new Window()
        {
            Title = "Delete HTML supported file type",
            Content = dialogControl,
            SizeToContent = SizeToContent.WidthAndHeight,
            ResizeMode = ResizeMode.CanResizeWithGrip,
            WindowStartupLocation = WindowStartupLocation.CenterScreen
